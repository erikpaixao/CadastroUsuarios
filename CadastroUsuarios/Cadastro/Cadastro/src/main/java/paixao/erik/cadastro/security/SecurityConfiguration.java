...
public class SecurityConfiguration  extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// Package Authorities.
		.antMatchers(HttpMethod.GET, ServicePath.CALENDAR_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
		.antMatchers(HttpMethod.POST, ServicePath.CALENDAR_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
		.antMatchers(HttpMethod.PUT, ServicePath.CALENDAR_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
		.antMatchers(HttpMethod.DELETE, ServicePath.CALENDAR_PATH).hasAnyAuthority(AUTH_USER, AUTH_ADMIN)
		// User Authorities.
