...
public abstract class GenericService<T extends BaseEntity<?>, ID extends Serializable> implements ServiceMap {
	...
	public void update(@RequestBody T entityObject) throws Exception {
